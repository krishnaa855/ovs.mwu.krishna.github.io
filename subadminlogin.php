				...
				<nav class="navbar navbar-inverse" id="menu">
  					<div class="container-fluid">
		    			...
		    			<div class="collapse navbar-collapse" id="myNavbar">
					        ...
					        <li class="active"><a href="subadminlogin.php"><span class="glyphicon glyphicon-log-in"></span> Login</a>
					        </li>
					      	</ul>
		    			</div>
  					</div>
...
if(isset($_POST['Login']))
{
  ...
  $query ="SELECT * FROM subadmin WHERE username='$user' && password='$password'";
