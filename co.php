...
<html lang="en">
    <head>
        ...
        <title>Online Voting System| View Candidate</title>
...
<?php include('leftbar.php');?>  
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">View Candidate</h2>
       ...
       $cnt=1;
        ...
        {?>
            ...
            <td data-label ='Code No'>".$row['code']."</td>
            <td data-label ='Registration No'>".$row['regno']."</td>
            <td data-label ='Email'>".$row['email']."</td>
            <td data-label ='Mobile'>".$row['contact']."</td>
            <td data-label ='Address'>".$row['address']."</td>

            <td data-label ='Action'><div style='float:top;'><a  href='updatecan.php?code=$row[code]&name=$row[name]&mname=$row[mname]&lname=$row[lname]&address=$row[address]&contact=$row[contact]&email=$row[email]&gender=$row[gender]&moto=$row[moto]&regno=$row[regno]'><input type='submit' value='Edit'id='editbtn'></a></div>
            <div style='float:bottom;'>
<a href='deletecan.php?code=$row[code]&email=$row[email]' onclick='return checkdelete()'><input type='submit' value='Delete'id='deletebtn'></a></div>
