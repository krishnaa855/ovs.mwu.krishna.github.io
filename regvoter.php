...
<div class="container-fluid">
                    ...
                    <td><div class="form-group">
                        ...
                        <select class="form-control text" name="Sex" required="">
                            ...
                            <option value="Others">Others</option>
                                 ...
                                 <td><div class="form-group">
                        DOB:                        <input id='dob_raw' min="2001-20-20" class="form-control" type="date"  name="DOB"   onchange="dob();"  value="" required="">
                        
                    </div></td>
                     <td><div class="form-group">
                        AGE                       <input id='put_dob' class="form-control" type="number" name="age"  readonly="" value="" >
                        <script>
                              function dob(){
                                var raw=document.getElementById('dob_raw').value;
                                var dobYr=raw.split('-','1');
                                var Rdate=new Date();   
                                var Ryr=Rdate.getFullYear();    

                                var Ag=Ryr-dobYr;

                               $('#put_dob').attr('value',Ag);  
                               if(Ag >= 18){
                                   $('#put_dob').css('border','2px solid green');
                                   $('#general_save_btn').removeAttr('disabled');
                                   $('#general_save_btn').removeAttr('title');
                               }
                               if(Ag < 18){
                                   alert('Required Age is 18 or Above');
                                   $('#put_dob').css('border', '2px solid red');
                                   $('#general_save_btn').attr('disabled',true);
                                   $("#general_save_btn").attr('title', 'Your age must be greater or equal to 18 to submit this form');
                               }
                ...
                <td>
                    ...
                    <td><div class="form-group">
                        ...
                        Address:                        <textarea class="form-control text" name="Address" autocomplete="off" placeholder="Enter Your Validate Address" rows="1" required=""></textarea>
                    </div></td>
                             </tr>
                              <tr>
                                 <td colspan="3"> <div class="form-group">
