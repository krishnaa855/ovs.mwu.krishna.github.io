...
<body>
	...
	<form action="" method="GET">
		<table border="0" bgcolor="black" align="center" cellspacing="20">
			<tr>
				<td>District Code</td>
				<td><input type="text" value="<?php echo "$dc"?>" name="dc"></td>
			</tr>
			<tr>
				<td>First Name</td>
...
if($_GET['submit'])
{
	...
	$query="UPDATE addvoter SET districtcode='$dc',Name='$Name',mname='$mname',lname='$lname',Address='$Address',Contact='$Contact',email='$email',sex='$sex',DOB='$DOB',citizenship='$citizenship',voterno='$voterno',age='$age'WHERE email='$email'";
	...
	if($data)
	{
		...
		?>
	<META HTTP-EQUIV="Refresh"CONTENT="0; URL=http://localhost/voting/vo.php">
	<?php
	}
	else{
